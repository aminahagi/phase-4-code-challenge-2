...
class PowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create power" do
    assert_difference("Power.count") do
      post powers_url, params: { power: { description: @power.description, name: @power.name } }
    end
  ...
  test "should update power" do
    patch power_url(@power), params: { power: { description: @power.description, name: @power.name } }
